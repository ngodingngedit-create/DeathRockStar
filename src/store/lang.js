...
export const t = (key) => {
  const dictionary = {
    ...
    // Dashboard Page
    dashTitle: { id: 'Statistik Merchandise', en: 'Merchandise Statistics' },
    dashSubtitle: { id: 'Ringkasan penjualan dan performa', en: 'Overview of sales and performances' },
    dashTotalSales: { id: 'Total sales', en: 'Total sales' },
    dashSuccess: { id: 'Berhasil', en: 'Successful' },
    dashPending: { id: 'Pending', en: 'Pending' },
    dashFailed: { id: 'Gagal (expired)', en: 'Failed (expired)' },
    dashTotalTrx: { id: 'Total transaksi', en: 'Total transactions' },
    dashExport: { id: 'Export Excel', en: 'Export Excel' },
    dashTabTrx: { id: 'Daftar Transaksi', en: 'Transaction List' },
    dashTabStock: { id: 'Report Stock', en: 'Stock Report' },
    dashTrxUnit: { id: 'Transaksi', en: 'Transactions' },
    dashVariantUnit: { id: 'Varian', en: 'Variants' },
    dashSearchPh: { id: 'Cari Invoice atau Nama...', en: 'Search Invoice or Name...' },
    variantSearchPh: { id: 'Cari Produk, Varian, atau SKU...', en: 'Search Product, Variant, or SKU...' },
    dashAllStatus: { id: 'Semua Status', en: 'All Statuses' },
    dashSortStatus: { id: 'Urutkan status', en: 'Sort by status' },
    dashNoTrx: { id: 'Transaksi tidak ditemukan.', en: 'No transactions found' },
    dashNoStock: { id: 'Stok tidak ditemukan.', en: 'No stock found' },
    dashPage: { id: 'Halaman', en: 'Page' },
    dashOf: { id: 'dari', en: 'of' },
    dashAllProducts: { id: 'Semua Produk', en: 'All Products' },
    dashThCustomer: { id: 'Pelanggan', en: 'Customer' },
    dashThProduct: { id: 'Produk', en: 'Product' },
    dashThStatus: { id: 'Status', en: 'Status' },
    dashThTotal: { id: 'Grand Total', en: 'Grand Total' },
    dashThVariant: { id: 'Varian', en: 'Variant' },
    dashThPrice: { id: 'Harga', en: 'Price' },
    dashThStockStart: { id: 'Stock awal', en: 'Initial stock' },
    dashThSold: { id: 'Terjual', en: 'Sold' },
    dashThRemaining: { id: 'Sisa stock', en: 'Remaining stock' },
    profileDashboard: { id: 'Dashboard', en: 'Dashboard' },
    profileLogout: { id: 'Keluar', en: 'Log out' },
    navLiveReport: { id: 'Laporan Live', en: 'Live Report' },
    navCetakResi: { id: 'Cetak Resi', en: 'Print Receipt' },
    adminMenu: { id: 'MENU ADMIN', en: 'ADMIN MENU' },
    resiTitle: { id: 'Cetak Resi Pengiriman', en: 'Shipping Receipts' },
    resiSubtitle: { id: 'Cetak resi pengiriman pesanan', en: 'Print order shipping receipts' },
    resiTotal: { id: 'Total order', en: 'Total orders' },
    resiReady: { id: 'Siap cetak', en: 'Ready to print' },
    resiShipped: { id: 'Sudah dikirim', en: 'Shipped' },
    resiPendingShip: { id: 'Belum dikirim', en: 'Not shipped yet' },
    resiSearchPh: { id: 'Cari Invoice atau Nama...', en: 'Search Invoice or Name...' },
    resiThInvoice: { id: 'INVOICE', en: 'INVOICE' },
    resiThShipStatus: { id: 'STATUS PENGIRIMAN', en: 'SHIPPING STATUS' },
    resiThAction: { id: 'AKSI', en: 'ACTION' },
    resiPrint: { id: 'Cetak Resi', en: 'Print' },
    resiNoData: { id: 'Data resi tidak ditemukan.', en: 'No receipts found' },
    shipWaiting: { id: 'Menunggu pembayaran', en: 'Awaiting payment' },
    shipReady: { id: 'Belum dikirim', en: 'Not shipped' },
    shipShipped: { id: 'Dikirim', en: 'Shipped' },
    shipDone: { id: 'Diterima', en: 'Delivered' },
    loginTitle: { id: 'Masuk', en: 'Sign In' },
    loginWelcome: { id: 'Selamat Datang Kembali', en: 'Welcome Back' },
    loginSubtitle: { id: 'Kelola event dan merch dalam satu tempat.', en: 'Manage your events and merch in one place.' },
    loginEmail: { id: 'Email', en: 'Email' },
    loginPassword: { id: 'Password', en: 'Password' },
    loginContinue: { id: 'Lanjutkan', en: 'Continue' },
    loginSubmit: { id: 'Masuk', en: 'Sign In' },
    loginNoAccount: { id: 'Belum punya akun?', en: "Don't have an account?" },
    loginRegister: { id: 'Daftar Akun', en: 'Create Account' },
    loginTerms1: { id: 'Dengan masuk, Anda menyetujui', en: 'By signing in, you agree to' },
    loginTerms2: { id: 'Syarat & Ketentuan', en: 'Terms & Conditions' },
    loginHub: { id: 'DEATHROCKSTAR MERCHANT HUB', en: 'DEATHROCKSTAR MERCHANT HUB' },
    loginChange: { id: 'Ubah', en: 'Change' },
    loginBrandTag: { id: 'HIDUP UNTUK SCENE', en: 'LIVE FOR THE SCENE' },
    loginProcessing: { id: 'Memproses...', en: 'Processing...' },
    loginBack: { id: 'Kembali ke Beranda', en: 'Back to Home' },
    loginOtpTitle: { id: 'Cek Email Anda', en: 'Check Your Email' },
    loginOtpSub: { id: 'Masukkan 6 digit kode verifikasi yang dikirim ke', en: 'Enter the 6-digit verification code sent to' },
    loginOtpLabel: { id: 'Kode Verifikasi', en: 'Verification Code' },
    loginVerify: { id: 'Verifikasi', en: 'Verify' },
    loginErrEmailEmpty: { id: 'Email wajib diisi.', en: 'Email is required.' },
    loginErrEmailInvalid: { id: 'Masukkan alamat email yang valid.', en: 'Enter a valid email address.' },
    loginErrOtpIncomplete: { id: 'Lengkapi 6 digit kode verifikasi.', en: 'Complete the 6-digit verification code.' },
    loginErrOtpInvalid: { id: 'Kode harus 6 angka.', en: 'Code must be 6 digits.' }
  }
